...
TEST (influxdb4c, format_line)
{
    ...
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_NEW_LINE), -1);
    ASSERT_FALSE(line);
    ...
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_TAG("k", "v"), INFLUX_NEW_LINE), -1);
    ASSERT_FALSE(line);
    ...
    ASSERT_TRUE(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_STR("s", "string"), 
        INFLUX_NEW_LINE, INFLUX_MEAS("bar"), INFLUX_F_FLT("f", 0, 0), INFLUX_END));
    ASSERT_TRUE(line != NULL);
    ...
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_STR("s", "string"), INFLUX_NEW_LINE), -1);
    ASSERT_FALSE(line);
    ...
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_FLT("f", 28.39, 0), INFLUX_NEW_LINE), -1);
    ASSERT_FALSE(line);
    ...
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_INT("i", 1048576), INFLUX_NEW_LINE), -1);
    ASSERT_FALSE(line);
    ...
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_BOL("b", 1), INFLUX_NEW_LINE), -1);
    ASSERT_FALSE(line);
    ...
    // N: NEW_LINE after TIMESTAMP
    ASSERT_TRUE(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_STR("s", "string"), 
        INFLUX_TS(1512722735522840439), INFLUX_NEW_LINE, INFLUX_MEAS("bar"), INFLUX_F_FLT("f", 0, 0), INFLUX_END));
    ASSERT_TRUE(line != NULL);
    ...
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_STR("s", "string"), 
        INFLUX_TS(1512722735522840439), INFLUX_MEAS("bar")), -1);
    ASSERT_FALSE(line);
    ASSERT_EQ(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_STR("s", "string"), 
    ...
    ASSERT_TRUE(format_line(&line, INFLUX_MEAS("foo"), INFLUX_F_FLT("f", 28.39, 2), 
        INFLUX_TS(1512722735522840439), 
        INFLUX_NEW_LINE, INFLUX_MEAS("foo"), INFLUX_F_FLT("f", 28.39, 0), INFLUX_END));
    ASSERT_TRUE(line != NULL);
